...
APointCollection::APointCollection()
{
	...
	ImmutablePts.Add(Pt_11);
	Pt_11->SetupAttachment(RootComponent);
...
{
	checkf(ImmutablePts.Num()>= NumPoints , TEXT("Attempted to access ImmutablePts out of bound"));
	...
	for (USceneComponent* Pt : ImmutablePts)
	{
		...
		UAuraAbilitySystemLibrary::GetLifePlayerWithinRadius(this,IgnoreActors, TArray<AActor*>(),1500.f,GetActorLocation());
